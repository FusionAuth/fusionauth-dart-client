...
class FusionAuthClient {
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> enableTwoFactor(String userId, TwoFactorRequest request) {
    return _start<void, Errors>()
        .withUri('/api/user/two-factor')
        .withUriSegment(userId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> loginPing(String userId, String applicationId, String callerIPAddress) {
    return _start<void, Errors>()
        .withUri('/api/login')
        .withUriSegment(userId)
        .withUriSegment(applicationId)
