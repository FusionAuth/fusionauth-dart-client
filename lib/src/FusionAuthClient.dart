...
class FusionAuthClient {
  ...
  Future<ClientResponse<ActionResponse, Errors>> actionUser(ActionRequest request) {
  ...
  Future<ClientResponse<FamilyResponse, Errors>> addUserToFamily(String familyId, FamilyRequest request) {
    return _start<FamilyResponse, Errors>()
        .withUri('/api/user/family')
        .withUriSegment(familyId)
        .withJSONBody(request)
        .withMethod('PUT')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => FamilyResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<ActionResponse>>}
  Future<ClientResponse<ActionResponse, Errors>> cancelAction(String actionId, ActionRequest request) {
    return _start<ActionResponse, Errors>()
        .withUri('/api/user/action')
  ...
  Future<ClientResponse<ChangePasswordResponse, Errors>> changePassword(String changePasswordId, ChangePasswordRequest request) {
    return _startAnonymous<ChangePasswordResponse, Errors>()
        .withUri('/api/user/change-password')
        .withUriSegment(changePasswordId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => ChangePasswordResponse.fromJson(d)))
        .go();
  }
  ...
  /// @param {ChangePasswordRequest} request The change password request that contains all of the information used to change the password.
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> changePasswordByIdentity(ChangePasswordRequest request) {
    return _start<void, Errors>()
        .withUri('/api/user/change-password')
        .withJSONBody(request)
        .withMethod('POST')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> commentOnUser(UserCommentRequest request) {
    return _start<void, Errors>()
  ...
  Future<ClientResponse<IPAccessControlListResponse, Errors>> createACL(String accessControlListId, IPAccessControlListRequest request) {
    return _start<IPAccessControlListResponse, Errors>()
        .withUri('/api/ip-acl')
        .withUriSegment(accessControlListId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => IPAccessControlListResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<APIKeyResponse, Errors>> createAPIKey(String keyId, APIKeyRequest request) {
    return _start<APIKeyResponse, Errors>()
        .withUri('/api/api-key')
        .withUriSegment(keyId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => APIKeyResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<ApplicationResponse, Errors>> createApplication(String applicationId, ApplicationRequest request) {
  ...
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, Errors>> createApplicationRole(String applicationId, String roleId, ApplicationRequest request) {
    return _start<ApplicationResponse, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withUriSegment("role")
  ...
  Future<ClientResponse<AuditLogResponse, Errors>> createAuditLog(AuditLogRequest request) {
  ...
  Future<ClientResponse<ConsentResponse, Errors>> createConsent(String consentId, ConsentRequest request) {
    return _start<ConsentResponse, Errors>()
        .withUri('/api/consent')
        .withUriSegment(consentId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => ConsentResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<EmailTemplateResponse, Errors>> createEmailTemplate(String emailTemplateId, EmailTemplateRequest request) {
  ...
  /// @returns {Promise<ClientResponse<FamilyResponse>>}
  Future<ClientResponse<FamilyResponse, Errors>> createFamily(String familyId, FamilyRequest request) {
    return _start<FamilyResponse, Errors>()
        .withUri('/api/user/family')
        .withUriSegment(familyId)
        .withJSONBody(request)
  ...
  Future<ClientResponse<FormResponse, Errors>> createForm(String formId, FormRequest request) {
    return _start<FormResponse, Errors>()
        .withUri('/api/form')
        .withUriSegment(formId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => FormResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<FormFieldResponse, Errors>> createFormField(String fieldId, FormFieldRequest request) {
    return _start<FormFieldResponse, Errors>()
        .withUri('/api/form/field')
        .withUriSegment(fieldId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => FormFieldResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<GroupResponse, Errors>> createGroup(String groupId, GroupRequest request) {
    return _start<GroupResponse, Errors>()
        .withUri('/api/group')
        .withUriSegment(groupId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => GroupResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<MemberResponse, Errors>> createGroupMembers(MemberRequest request) {
    return _start<MemberResponse, Errors>()
        .withUri('/api/group/member')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => MemberResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<IdentityProviderResponse, Errors>> createIdentityProvider(String identityProviderId, IdentityProviderRequest request) {
  ...
  Future<ClientResponse<LambdaResponse, Errors>> createLambda(String lambdaId, LambdaRequest request) {
  ...
  Future<ClientResponse<TenantResponse, Errors>> createTenant(String tenantId, TenantRequest request) {
    return _start<TenantResponse, Errors>()
        .withUri('/api/tenant')
        .withUriSegment(tenantId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => TenantResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<ThemeResponse, Errors>> createTheme(String themeId, ThemeRequest request) {
    return _start<ThemeResponse, Errors>()
        .withUri('/api/theme')
        .withUriSegment(themeId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => ThemeResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<UserResponse, Errors>> createUser(String userId, UserRequest request) {
  ...
  Future<ClientResponse<UserActionResponse, Errors>> createUserAction(String userActionId, UserActionRequest request) {
    return _start<UserActionResponse, Errors>()
        .withUri('/api/user-action')
        .withUriSegment(userActionId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => UserActionResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<UserActionReasonResponse, Errors>> createUserActionReason(String userActionReasonId, UserActionReasonRequest request) {
    return _start<UserActionReasonResponse, Errors>()
        .withUri('/api/user-action-reason')
        .withUriSegment(userActionReasonId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => UserActionReasonResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<UserConsentResponse, Errors>> createUserConsent(String userConsentId, UserConsentRequest request) {
    return _start<UserConsentResponse, Errors>()
        .withUri('/api/user/consent')
        .withUriSegment(userConsentId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => UserConsentResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<IdentityProviderLinkResponse, Errors>> createUserLink(IdentityProviderLinkRequest request) {
    return _start<IdentityProviderLinkResponse, Errors>()
        .withUri('/api/identity-provider/link')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => IdentityProviderLinkResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<WebhookResponse, Errors>> createWebhook(String webhookId, WebhookRequest request) {
    return _start<WebhookResponse, Errors>()
        .withUri('/api/webhook')
        .withUriSegment(webhookId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => WebhookResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deactivateApplication(String applicationId) {
    return _start<void, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deactivateUserAction(String userActionId) {
    return _start<void, Errors>()
        .withUri('/api/user-action')
        .withUriSegment(userActionId)
        .withMethod('DELETE')
  ...
  Future<ClientResponse<UserDeleteResponse, Errors>> deactivateUsers(List<String> userIds) {
    return _start<UserDeleteResponse, Errors>()
        ...
        .withMethod('DELETE')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => UserDeleteResponse.fromJson(d)))
        .go();
  }
  ...
  /// @param {List<String>} userIds The ids of the users to deactivate.
  /// @returns {Promise<ClientResponse<UserDeleteResponse>>}
  Future<ClientResponse<UserDeleteResponse, Errors>> deactivateUsersByIds(List<String> userIds) {
    return _start<UserDeleteResponse, Errors>()
        .withUri('/api/user/bulk')
        .withParameter('userId', userIds)
        .withParameter('dryRun', false)
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deleteApplicationRole(String applicationId, String roleId) {
    return _start<void, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withUriSegment("role")
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deleteEmailTemplate(String emailTemplateId) {
    return _start<void, Errors>()
        .withUri('/api/email/template')
        .withUriSegment(emailTemplateId)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deleteEntityGrant(String entityId, String recipientEntityId, String userId) {
    return _start<void, Errors>()
        .withUri('/api/entity')
        .withUriSegment(entityId)
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deleteGroupMembers(MemberDeleteRequest request) {
    return _start<void, Errors>()
        .withUri('/api/group/member')
        .withJSONBody(request)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deleteIdentityProvider(String identityProviderId) {
    return _start<void, Errors>()
        .withUri('/api/identity-provider')
        .withUriSegment(identityProviderId)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deleteRegistration(String userId, String applicationId) {
    return _start<void, Errors>()
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> deleteUserActionReason(String userActionReasonId) {
    return _start<void, Errors>()
        .withUri('/api/user-action-reason')
        .withUriSegment(userActionReasonId)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<IdentityProviderLinkResponse>>}
  Future<ClientResponse<IdentityProviderLinkResponse, Errors>> deleteUserLink(String identityProviderId, String identityProviderUserId, String userId) {
    return _start<IdentityProviderLinkResponse, Errors>()
        .withUri('/api/identity-provider/link')
  ...
  Future<ClientResponse<UserDeleteResponse, Errors>> deleteUsers(UserDeleteRequest request) {
    return _start<UserDeleteResponse, Errors>()
        .withUri('/api/user/bulk')
        .withJSONBody(request)
        .withMethod('DELETE')
  ...
  /// @param {UserDeleteRequest} request The UserDeleteRequest.
  /// @returns {Promise<ClientResponse<UserDeleteResponse>>}
  Future<ClientResponse<UserDeleteResponse, Errors>> deleteUsersByQuery(UserDeleteRequest request) {
    return _start<UserDeleteResponse, Errors>()
        .withUri('/api/user/bulk')
        .withJSONBody(request)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> disableTwoFactor(String userId, String methodId, String code) {
    return _start<void, Errors>()
  ...
  Future<ClientResponse<TwoFactorResponse, Errors>> enableTwoFactor(String userId, TwoFactorRequest request) {
    return _start<TwoFactorResponse, Errors>()
        .withUri('/api/user/two-factor')
        .withUriSegment(userId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => TwoFactorResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<AccessToken, OAuthError>> exchangeOAuthCodeForAccessToken(String code, String client_id, String client_secret, String redirect_uri) {
    ...
    return _startAnonymous<AccessToken, OAuthError>()
        ...
        .withFormData(body)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => AccessToken.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<AccessToken>>}
  Future<ClientResponse<AccessToken, OAuthError>> exchangeOAuthCodeForAccessTokenUsingPKCE(String code, String client_id, String client_secret, String redirect_uri, String code_verifier) {
    var body = Map<String, dynamic>();
    body['code'] = code;
    body['client_id'] = client_id;
    body['client_secret'] = client_secret;
  ...
  /// @returns {Promise<ClientResponse<AccessToken>>}
  Future<ClientResponse<AccessToken, OAuthError>> exchangeRefreshTokenForAccessToken(String refresh_token, String client_id, String client_secret, String scope, String user_code) {
    var body = Map<String, dynamic>();
  ...
  /// @param {String} user_code (Optional) The end-user verification code. This code is required if using this endpoint to approve the Device Authorization.
  /// @returns {Promise<ClientResponse<AccessToken>>}
  Future<ClientResponse<AccessToken, OAuthError>> exchangeUserCredentialsForAccessToken(String username, String password, String client_id, String client_secret, String scope, String user_code) {
    var body = Map<String, dynamic>();
  ...
  Future<ClientResponse<ForgotPasswordResponse, Errors>> forgotPassword(ForgotPasswordRequest request) {
    return _start<ForgotPasswordResponse, Errors>()
        .withUri('/api/user/forgot-password')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => ForgotPasswordResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<VerifyEmailResponse, void>> generateEmailVerificationId(String email) {
  ...
  Future<ClientResponse<KeyResponse, Errors>> generateKey(String keyId, KeyRequest request) {
    return _start<KeyResponse, Errors>()
        .withUri('/api/key/generate')
        .withUriSegment(keyId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => KeyResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<VerifyRegistrationResponse, void>> generateRegistrationVerificationId(String email, String applicationId) {
    return _start<VerifyRegistrationResponse, void>()
        ...
        .withMethod('PUT')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => VerifyRegistrationResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<TwoFactorRecoveryCodeResponse, Errors>> generateTwoFactorRecoveryCodes(String userId) {
    return _start<TwoFactorRecoveryCodeResponse, Errors>()
        .withHeader('Content-Type', 'text/plain')
        .withUri('/api/user/two-factor/recovery-code')
        .withUriSegment(userId)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => TwoFactorRecoveryCodeResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<LoginResponse, Errors>> identityProviderLogin(IdentityProviderLoginRequest request) {
    return _startAnonymous<LoginResponse, Errors>()
        .withUri('/api/identity-provider/login')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => LoginResponse.fromJson(d)))
        .go();
  }
  ...
  /// @param {KeyRequest} request The request object that contains all of the information used to create the key.
  /// @returns {Promise<ClientResponse<KeyResponse>>}
  Future<ClientResponse<KeyResponse, Errors>> importKey(String keyId, KeyRequest request) {
    return _start<KeyResponse, Errors>()
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> importRefreshTokens(RefreshTokenImportRequest request) {
    return _start<void, Errors>()
  ...
  Future<ClientResponse<IssueResponse, Errors>> issueJWT(String applicationId, String encodedJWT, String refreshToken) {
    return _startAnonymous<IssueResponse, Errors>()
        ...
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => IssueResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<LoginResponse>>}
  Future<ClientResponse<LoginResponse, Errors>> loginPing(String userId, String applicationId, String callerIPAddress) {
    return _start<LoginResponse, Errors>()
        .withUri('/api/login')
        .withUriSegment(userId)
        .withUriSegment(applicationId)
  ...
  ///
  /// @param {bool} global When this value is set to true all of the refresh tokens issued to the owner of the
  ...
  Future<ClientResponse<LookupResponse, void>> lookupIdentityProvider(String domain) {
    return _start<LookupResponse, void>()
        .withUri('/api/identity-provider/lookup')
        .withParameter('domain', domain)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => LookupResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<ActionResponse>>}
  Future<ClientResponse<ActionResponse, Errors>> modifyAction(String actionId, ActionRequest request) {
    return _start<ActionResponse, Errors>()
        .withUri('/api/user/action')
        .withUriSegment(actionId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<LoginResponse>>}
  Future<ClientResponse<LoginResponse, Errors>> passwordlessLogin(PasswordlessLoginRequest request) {
    return _startAnonymous<LoginResponse, Errors>()
  ...
  /// @param {APIKeyRequest} request The request object that contains all of the information needed to create the APIKey.
  /// @returns {Promise<ClientResponse<APIKeyResponse>>}
  Future<ClientResponse<APIKeyResponse, Errors>> patchAPIKey(String keyId, APIKeyRequest request) {
    return _start<APIKeyResponse, Errors>()
        .withUri('/api/api-key')
        .withUriSegment(keyId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, Errors>> patchApplication(String applicationId, ApplicationRequest request) {
    return _start<ApplicationResponse, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, Errors>> patchApplicationRole(String applicationId, String roleId, ApplicationRequest request) {
    return _start<ApplicationResponse, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withUriSegment("role")
  ...
  /// @returns {Promise<ClientResponse<ConsentResponse>>}
  Future<ClientResponse<ConsentResponse, Errors>> patchConsent(String consentId, ConsentRequest request) {
    return _start<ConsentResponse, Errors>()
        .withUri('/api/consent')
        .withUriSegment(consentId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<EmailTemplateResponse>>}
  Future<ClientResponse<EmailTemplateResponse, Errors>> patchEmailTemplate(String emailTemplateId, EmailTemplateRequest request) {
    return _start<EmailTemplateResponse, Errors>()
        .withUri('/api/email/template')
        .withUriSegment(emailTemplateId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<GroupResponse>>}
  Future<ClientResponse<GroupResponse, Errors>> patchGroup(String groupId, GroupRequest request) {
    return _start<GroupResponse, Errors>()
        .withUri('/api/group')
        .withUriSegment(groupId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<IdentityProviderResponse>>}
  Future<ClientResponse<IdentityProviderResponse, Errors>> patchIdentityProvider(String identityProviderId, IdentityProviderRequest request) {
    return _start<IdentityProviderResponse, Errors>()
        .withUri('/api/identity-provider')
        .withUriSegment(identityProviderId)
        .withJSONBody(request)
  ...
  Future<ClientResponse<IntegrationResponse, Errors>> patchIntegrations(IntegrationRequest request) {
    return _start<IntegrationResponse, Errors>()
        .withUri('/api/integration')
        .withJSONBody(request)
        .withMethod('PATCH')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => IntegrationResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<LambdaResponse>>}
  Future<ClientResponse<LambdaResponse, Errors>> patchLambda(String lambdaId, LambdaRequest request) {
    return _start<LambdaResponse, Errors>()
        .withUri('/api/lambda')
        .withUriSegment(lambdaId)
        .withJSONBody(request)
  ...
  Future<ClientResponse<RegistrationResponse, Errors>> patchRegistration(String userId, RegistrationRequest request) {
    return _start<RegistrationResponse, Errors>()
        .withUri('/api/user/registration')
        .withUriSegment(userId)
        .withJSONBody(request)
        .withMethod('PATCH')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => RegistrationResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<SystemConfigurationResponse, Errors>> patchSystemConfiguration(SystemConfigurationRequest request) {
    return _start<SystemConfigurationResponse, Errors>()
        .withUri('/api/system-configuration')
        .withJSONBody(request)
        .withMethod('PATCH')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => SystemConfigurationResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<TenantResponse>>}
  Future<ClientResponse<TenantResponse, Errors>> patchTenant(String tenantId, TenantRequest request) {
    return _start<TenantResponse, Errors>()
        .withUri('/api/tenant')
        .withUriSegment(tenantId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<ThemeResponse>>}
  Future<ClientResponse<ThemeResponse, Errors>> patchTheme(String themeId, ThemeRequest request) {
    return _start<ThemeResponse, Errors>()
        .withUri('/api/theme')
        .withUriSegment(themeId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, Errors>> patchUser(String userId, UserRequest request) {
    return _start<UserResponse, Errors>()
        .withUri('/api/user')
        .withUriSegment(userId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<UserActionResponse>>}
  Future<ClientResponse<UserActionResponse, Errors>> patchUserAction(String userActionId, UserActionRequest request) {
    return _start<UserActionResponse, Errors>()
        .withUri('/api/user-action')
        .withUriSegment(userActionId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<UserActionReasonResponse>>}
  Future<ClientResponse<UserActionReasonResponse, Errors>> patchUserActionReason(String userActionReasonId, UserActionReasonRequest request) {
    return _start<UserActionReasonResponse, Errors>()
        .withUri('/api/user-action-reason')
        .withUriSegment(userActionReasonId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<UserConsentResponse>>}
  Future<ClientResponse<UserConsentResponse, Errors>> patchUserConsent(String userConsentId, UserConsentRequest request) {
    return _start<UserConsentResponse, Errors>()
        .withUri('/api/user/consent')
        .withUriSegment(userConsentId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, Errors>> reactivateApplication(String applicationId) {
    return _start<ApplicationResponse, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
  ...
  /// @returns {Promise<ClientResponse<UserActionResponse>>}
  Future<ClientResponse<UserActionResponse, Errors>> reactivateUserAction(String userActionId) {
    return _start<UserActionResponse, Errors>()
        .withUri('/api/user-action')
        .withUriSegment(userActionId)
        .withParameter('reactivate', true)
  ...
  /// @returns {Promise<ClientResponse<LoginResponse>>}
  Future<ClientResponse<LoginResponse, Errors>> reconcileJWT(IdentityProviderLoginRequest request) {
    return _startAnonymous<LoginResponse, Errors>()
  ...
  /// @returns {Promise<ClientResponse<RegistrationResponse>>}
  Future<ClientResponse<RegistrationResponse, Errors>> register(String userId, RegistrationRequest request) {
    return _start<RegistrationResponse, Errors>()
        .withUri('/api/user/registration')
        .withUriSegment(userId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> removeUserFromFamily(String familyId, String userId) {
    return _start<void, Errors>()
        .withUri('/api/user/family')
        .withUriSegment(familyId)
        .withUriSegment(userId)
  ...
  /// @param {String} email The email address of the user that needs a new verification email.
  /// @returns {Promise<ClientResponse<VerifyEmailResponse>>}
  Future<ClientResponse<VerifyEmailResponse, Errors>> resendEmailVerification(String email) {
  ...
  /// @param {String} applicationId The Id of the application to be verified.
  /// @returns {Promise<ClientResponse<VerifyRegistrationResponse>>}
  Future<ClientResponse<VerifyRegistrationResponse, Errors>> resendRegistrationVerification(String email, String applicationId) {
  ...
  /// @returns {Promise<ClientResponse<IPAccessControlListResponse>>}
  Future<ClientResponse<IPAccessControlListResponse, void>> retrieveACL(String formId) {
  ...
  /// @returns {Promise<ClientResponse<ActionResponse>>}
  Future<ClientResponse<ActionResponse, Errors>> retrieveAction(String actionId) {
    return _start<ActionResponse, Errors>()
        .withUri('/api/user/action')
        .withUriSegment(actionId)
        .withMethod('GET')
  ...
  /// @returns {Promise<ClientResponse<ActionResponse>>}
  Future<ClientResponse<ActionResponse, Errors>> retrieveActions(String userId) {
    return _start<ActionResponse, Errors>()
        .withUri('/api/user/action')
        .withParameter('userId', userId)
        .withMethod('GET')
  ...
  /// @param {String} userId The Id of the user to fetch the actions for.
  /// @returns {Promise<ClientResponse<ActionResponse>>}
  Future<ClientResponse<ActionResponse, Errors>> retrieveActionsPreventingLogin(String userId) {
    return _start<ActionResponse, Errors>()
        .withUri('/api/user/action')
        .withParameter('userId', userId)
  ...
  /// @param {String} userId The Id of the user to fetch the actions for.
  /// @returns {Promise<ClientResponse<ActionResponse>>}
  Future<ClientResponse<ActionResponse, Errors>> retrieveActiveActions(String userId) {
    return _start<ActionResponse, Errors>()
        .withUri('/api/user/action')
        .withParameter('userId', userId)
  ...
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, void>> retrieveApplication(String applicationId) {
  ...
  /// @returns {Promise<ClientResponse<AuditLogResponse>>}
  Future<ClientResponse<AuditLogResponse, Errors>> retrieveAuditLog(num auditLogId) {
    return _start<AuditLogResponse, Errors>()
        .withUri('/api/system/audit-log')
  ...
  /// @returns {Promise<ClientResponse<ConsentResponse>>}
  Future<ClientResponse<ConsentResponse, void>> retrieveConsent(String consentId) {
  ...
  Future<ClientResponse<DailyActiveUserReportResponse, Errors>> retrieveDailyActiveReport(String applicationId, num start, num end) {
    return _start<DailyActiveUserReportResponse, Errors>()
        ...
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => DailyActiveUserReportResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<EmailTemplateResponse>>}
  Future<ClientResponse<EmailTemplateResponse, void>> retrieveEmailTemplate(String emailTemplateId) {
  ...
  Future<ClientResponse<PreviewResponse, Errors>> retrieveEmailTemplatePreview(PreviewRequest request) {
    return _start<PreviewResponse, Errors>()
        .withUri('/api/email/template/preview')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => PreviewResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<EntityGrantResponse, Errors>> retrieveEntityGrant(String entityId, String recipientEntityId, String userId) {
    return _start<EntityGrantResponse, Errors>()
        ...
        .withParameter('userId', userId)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => EntityGrantResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<EventLogResponse, Errors>> retrieveEventLog(num eventLogId) {
    return _start<EventLogResponse, Errors>()
        .withUri('/api/system/event-log')
        .withUriSegment(eventLogId)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => EventLogResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<FamilyResponse>>}
  Future<ClientResponse<FamilyResponse, void>> retrieveFamilyMembersByFamilyId(String familyId) {
    return _start<FamilyResponse, void>()
        .withUri('/api/user/family')
        .withUriSegment(familyId)
        .withMethod('GET')
  ...
  /// @returns {Promise<ClientResponse<FormFieldResponse>>}
  Future<ClientResponse<FormFieldResponse, void>> retrieveFormField(String fieldId) {
  ...
  ///
  /// @returns {Promise<ClientResponse<IdentityProviderResponse>>}
  Future<ClientResponse<IdentityProviderResponse, void>> retrieveIdentityProviders() {
  ...
  /// @param {String} userId The Id of the user to fetch the actions for.
  /// @returns {Promise<ClientResponse<ActionResponse>>}
  Future<ClientResponse<ActionResponse, Errors>> retrieveInactiveActions(String userId) {
    return _start<ActionResponse, Errors>()
        .withUri('/api/user/action')
        .withParameter('userId', userId)
  ...
  ///
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, void>> retrieveInactiveApplications() {
    return _start<ApplicationResponse, void>()
        .withUri('/api/application')
  ...
  Future<ClientResponse<PublicKeyResponse, void>> retrieveJWTPublicKey(String keyId) {
    return _startAnonymous<PublicKeyResponse, void>()
        .withUri('/api/jwt/public-key')
        .withParameter('kid', keyId)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => PublicKeyResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<PublicKeyResponse>>}
  Future<ClientResponse<PublicKeyResponse, void>> retrieveJWTPublicKeyByApplicationId(String applicationId) {
    return _startAnonymous<PublicKeyResponse, void>()
        .withUri('/api/jwt/public-key')
        .withParameter('applicationId', applicationId)
        .withMethod('GET')
  ...
  Future<ClientResponse<JWKSResponse, void>> retrieveJsonWebKeySet() {
    return _startAnonymous<JWKSResponse, void>()
        ...
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => JWKSResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<LambdaResponse>>}
  Future<ClientResponse<LambdaResponse, Errors>> retrieveLambda(String lambdaId) {
    return _start<LambdaResponse, Errors>()
        .withUri('/api/lambda')
        .withUriSegment(lambdaId)
        .withMethod('GET')
  ...
  /// @returns {Promise<ClientResponse<LambdaResponse>>}
  Future<ClientResponse<LambdaResponse, void>> retrieveLambdasByType(LambdaType type) {
    return _start<LambdaResponse, void>()
        .withUri('/api/lambda')
        .withParameter('type', type)
        .withMethod('GET')
  ...
  Future<ClientResponse<LoginReportResponse, Errors>> retrieveLoginReport(String applicationId, num start, num end) {
  ...
  Future<ClientResponse<MonthlyActiveUserReportResponse, Errors>> retrieveMonthlyActiveReport(String applicationId, num start, num end) {
    return _start<MonthlyActiveUserReportResponse, Errors>()
        ...
        .withParameter('end', end)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => MonthlyActiveUserReportResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<OAuthConfigurationResponse, Errors>> retrieveOauthConfiguration(String applicationId) {
    return _start<OAuthConfigurationResponse, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withUriSegment("oauth-configuration")
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => OAuthConfigurationResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<OpenIdConfiguration, void>> retrieveOpenIdConfiguration() {
    return _startAnonymous<OpenIdConfiguration, void>()
        .withUri('/.well-known/openid-configuration')
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => OpenIdConfiguration.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<PasswordValidationRulesResponse, void>> retrievePasswordValidationRules() {
    return _startAnonymous<PasswordValidationRulesResponse, void>()
        .withUri('/api/tenant/password-validation-rules')
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => PasswordValidationRulesResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<PasswordValidationRulesResponse>>}
  Future<ClientResponse<PasswordValidationRulesResponse, void>> retrievePasswordValidationRulesWithTenantId(String tenantId) {
    return _startAnonymous<PasswordValidationRulesResponse, void>()
        .withUri('/api/tenant/password-validation-rules')
        .withUriSegment(tenantId)
        .withMethod('GET')
  ...
  Future<ClientResponse<PendingResponse, Errors>> retrievePendingChildren(String parentEmail) {
  ...
  Future<ClientResponse<ReactorResponse, void>> retrieveReactorStatus() {
    return _start<ReactorResponse, void>()
        .withUri('/api/reactor')
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => ReactorResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<RecentLoginResponse, Errors>> retrieveRecentLogins(num offset, num limit) {
    return _start<RecentLoginResponse, Errors>()
        .withUri('/api/user/recent-login')
        .withParameter('offset', offset)
        .withParameter('limit', limit)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => RecentLoginResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<RegistrationResponse>>}
  Future<ClientResponse<RegistrationResponse, Errors>> retrieveRegistration(String userId, String applicationId) {
    return _start<RegistrationResponse, Errors>()
        .withUri('/api/user/registration')
        .withUriSegment(userId)
        .withUriSegment(applicationId)
  ...
  Future<ClientResponse<RegistrationReportResponse, Errors>> retrieveRegistrationReport(String applicationId, num start, num end) {
    return _start<RegistrationReportResponse, Errors>()
        ...
        .withParameter('end', end)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => RegistrationReportResponse.fromJson(d)))
        .go();
  }
  ...
  ///
  /// @returns {Promise<ClientResponse<SystemConfigurationResponse>>}
  Future<ClientResponse<SystemConfigurationResponse, void>> retrieveSystemConfiguration() {
  ...
  /// @param {String} tenantId The Id of the tenant.
  /// @returns {Promise<ClientResponse<TenantResponse>>}
  Future<ClientResponse<TenantResponse, Errors>> retrieveTenant(String tenantId) {
    return _start<TenantResponse, Errors>()
        .withUri('/api/tenant')
        .withUriSegment(tenantId)
        .withMethod('GET')
  ...
  /// @returns {Promise<ClientResponse<TwoFactorRecoveryCodeResponse>>}
  Future<ClientResponse<TwoFactorRecoveryCodeResponse, Errors>> retrieveTwoFactorRecoveryCodes(String userId) {
    return _start<TwoFactorRecoveryCodeResponse, Errors>()
        .withUri('/api/user/two-factor/recovery-code')
        .withUriSegment(userId)
        .withMethod('GET')
  ...
  /// @returns {Promise<ClientResponse<UserActionResponse>>}
  Future<ClientResponse<UserActionResponse, void>> retrieveUserAction(String userActionId) {
    return _start<UserActionResponse, void>()
        .withUri('/api/user-action')
        .withUriSegment(userActionId)
        .withMethod('GET')
  ...
  /// @returns {Promise<ClientResponse<UserActionReasonResponse>>}
  Future<ClientResponse<UserActionReasonResponse, void>> retrieveUserActionReason(String userActionReasonId) {
  ...
  ///
  /// @returns {Promise<ClientResponse<UserActionReasonResponse>>}
  Future<ClientResponse<UserActionReasonResponse, void>> retrieveUserActionReasons() {
    return _start<UserActionReasonResponse, void>()
        .withUri('/api/user-action-reason')
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => UserActionReasonResponse.fromJson(d)))
  ...
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, Errors>> retrieveUserByChangePasswordId(String changePasswordId) {
    return _start<UserResponse, Errors>()
        .withUri('/api/user')
  ...
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, Errors>> retrieveUserByEmail(String email) {
    return _start<UserResponse, Errors>()
        .withUri('/api/user')
        .withParameter('email', email)
        .withMethod('GET')
  ...
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, Errors>> retrieveUserByLoginId(String loginId) {
    return _start<UserResponse, Errors>()
        .withUri('/api/user')
  ...
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, Errors>> retrieveUserByUsername(String username) {
    return _start<UserResponse, Errors>()
        .withUri('/api/user')
  ...
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, Errors>> retrieveUserByVerificationId(String verificationId) {
    return _start<UserResponse, Errors>()
        .withUri('/api/user')
  ...
  Future<ClientResponse<UserCommentResponse, Errors>> retrieveUserComments(String userId) {
    return _start<UserCommentResponse, Errors>()
        .withUri('/api/user/comment')
        .withUriSegment(userId)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => UserCommentResponse.fromJson(d)))
        .go();
  }
  ...
  /// @param {String} userConsentId The User consent Id
  /// @returns {Promise<ClientResponse<UserConsentResponse>>}
  Future<ClientResponse<UserConsentResponse, void>> retrieveUserConsent(String userConsentId) {
  ...
  /// @param {String} userId The User's Id
  /// @returns {Promise<ClientResponse<UserConsentResponse>>}
  Future<ClientResponse<UserConsentResponse, void>> retrieveUserConsents(String userId) {
    return _start<UserConsentResponse, void>()
        .withUri('/api/user/consent')
        .withParameter('userId', userId)
        .withMethod('GET')
  ...
  /// @param {String} encodedJWT The encoded JWT (access token).
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, OAuthError>> retrieveUserInfoFromAccessToken(String encodedJWT) {
  ...
  /// @returns {Promise<ClientResponse<IdentityProviderLinkResponse>>}
  Future<ClientResponse<IdentityProviderLinkResponse, Errors>> retrieveUserLink(String identityProviderId, String identityProviderUserId, String userId) {
    return _start<IdentityProviderLinkResponse, Errors>()
        .withUri('/api/identity-provider/link')
        .withParameter('identityProviderId', identityProviderId)
        .withParameter('identityProviderUserId', identityProviderUserId)
  ...
  /// @returns {Promise<ClientResponse<IdentityProviderLinkResponse>>}
  Future<ClientResponse<IdentityProviderLinkResponse, Errors>> retrieveUserLinksByUserId(String identityProviderId, String userId) {
    return _start<IdentityProviderLinkResponse, Errors>()
        .withUri('/api/identity-provider/link')
        .withParameter('identityProviderId', identityProviderId)
        .withParameter('userId', userId)
  ...
  /// @param {num} end The end instant as UTC milliseconds since Epoch.
  /// @returns {Promise<ClientResponse<LoginReportResponse>>}
  Future<ClientResponse<LoginReportResponse, Errors>> retrieveUserLoginReport(String applicationId, String userId, num start, num end) {
    return _start<LoginReportResponse, Errors>()
        .withUri('/api/report/login')
        .withParameter('applicationId', applicationId)
        .withParameter('userId', userId)
  ...
  /// @param {num} end The end instant as UTC milliseconds since Epoch.
  /// @returns {Promise<ClientResponse<LoginReportResponse>>}
  Future<ClientResponse<LoginReportResponse, Errors>> retrieveUserLoginReportByLoginId(String applicationId, String loginId, num start, num end) {
    return _start<LoginReportResponse, Errors>()
        .withUri('/api/report/login')
        .withParameter('applicationId', applicationId)
        .withParameter('loginId', loginId)
  ...
  /// @param {num} limit (Optional, defaults to 10) The number of records to retrieve.
  /// @returns {Promise<ClientResponse<RecentLoginResponse>>}
  Future<ClientResponse<RecentLoginResponse, Errors>> retrieveUserRecentLogins(String userId, num offset, num limit) {
    return _start<RecentLoginResponse, Errors>()
        .withUri('/api/user/recent-login')
        .withParameter('userId', userId)
        .withParameter('offset', offset)
  ...
  Future<ClientResponse<VersionResponse, Errors>> retrieveVersion() {
    return _start<VersionResponse, Errors>()
        ...
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => VersionResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<WebhookResponse>>}
  Future<ClientResponse<WebhookResponse, void>> retrieveWebhook(String webhookId) {
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> revokeRefreshToken(String token, String userId, String applicationId) {
    return _start<void, Errors>()
        .withUri('/api/jwt/refresh')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> revokeRefreshTokensByApplicationId(String applicationId) {
    return _start<void, Errors>()
        .withUri('/api/jwt/refresh')
        .withParameter('applicationId', applicationId)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> revokeRefreshTokensByUserId(String userId) {
    return _start<void, Errors>()
        .withUri('/api/jwt/refresh')
        .withParameter('userId', userId)
        .withMethod('DELETE')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> revokeRefreshTokensByUserIdForApplication(String userId, String applicationId) {
    return _start<void, Errors>()
        .withUri('/api/jwt/refresh')
        .withParameter('userId', userId)
        .withParameter('applicationId', applicationId)
  ...
  Future<ClientResponse<AuditLogSearchResponse, void>> searchAuditLogs(AuditLogSearchRequest request) {
    return _start<AuditLogSearchResponse, void>()
        .withUri('/api/system/audit-log/search')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => AuditLogSearchResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<EntitySearchResponse, Errors>> searchEntities(EntitySearchRequest request) {
  ...
  Future<ClientResponse<EntityGrantSearchResponse, Errors>> searchEntityGrants(EntityGrantSearchRequest request) {
    return _start<EntityGrantSearchResponse, Errors>()
        .withUri('/api/entity/grant/search')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => EntityGrantSearchResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<EventLogSearchResponse, void>> searchEventLogs(EventLogSearchRequest request) {
    return _start<EventLogSearchResponse, void>()
        .withUri('/api/system/event-log/search')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => EventLogSearchResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<LoginRecordSearchResponse, void>> searchLoginRecords(LoginRecordSearchRequest request) {
    return _start<LoginRecordSearchResponse, void>()
        .withUri('/api/system/login-record/search')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => LoginRecordSearchResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<SearchResponse, Errors>> searchUsers(List<String> ids) {
    return _start<SearchResponse, Errors>()
        ...
        .withParameter('ids', ids)
        .withMethod('GET')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => SearchResponse.fromJson(d)))
        .go();
  }
  ...
  /// @param {List<String>} ids The user ids to search for.
  /// @returns {Promise<ClientResponse<SearchResponse>>}
  Future<ClientResponse<SearchResponse, Errors>> searchUsersByIds(List<String> ids) {
    return _start<SearchResponse, Errors>()
        .withUri('/api/user/search')
        .withParameter('ids', ids)
        .withMethod('GET')
  ...
  ///    and sortFields.
  /// @returns {Promise<ClientResponse<SearchResponse>>}
  Future<ClientResponse<SearchResponse, Errors>> searchUsersByQuery(SearchRequest request) {
    return _start<SearchResponse, Errors>()
        .withUri('/api/user/search')
        .withJSONBody(request)
        .withMethod('POST')
  ...
  Future<ClientResponse<SearchResponse, Errors>> searchUsersByQueryString(SearchRequest request) {
    return _start<SearchResponse, Errors>()
        .withUri('/api/user/search')
        .withJSONBody(request)
        .withMethod('POST')
  ...
  Future<ClientResponse<SendResponse, Errors>> sendEmail(String emailTemplateId, SendRequest request) {
    return _start<SendResponse, Errors>()
        .withUri('/api/email/send')
        .withUriSegment(emailTemplateId)
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => SendResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> sendFamilyRequestEmail(FamilyEmailRequest request) {
    return _start<void, Errors>()
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> sendPasswordlessCode(PasswordlessSendRequest request) {
  ...
  Future<ClientResponse<void, Errors>> sendTwoFactorCode(TwoFactorSendRequest request) {
    return _start<void, Errors>()
  ...
  /// @param {TwoFactorSendRequest} request The request object that contains all of the information used to send the code.
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> sendTwoFactorCodeForEnableDisable(TwoFactorSendRequest request) {
    return _start<void, Errors>()
        .withUri('/api/two-factor/send')
        .withJSONBody(request)
        .withMethod('POST')
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> sendTwoFactorCodeForLoginUsingMethod(String twoFactorId, TwoFactorSendRequest request) {
    return _startAnonymous<void, Errors>()
        .withUri('/api/two-factor/send')
        .withUriSegment(twoFactorId)
        .withJSONBody(request)
  ...
  Future<ClientResponse<IdentityProviderStartLoginResponse, Errors>> startIdentityProviderLogin(IdentityProviderStartLoginRequest request) {
    return _start<IdentityProviderStartLoginResponse, Errors>()
        .withUri('/api/identity-provider/start')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => IdentityProviderStartLoginResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<PasswordlessStartResponse, Errors>> startPasswordlessLogin(PasswordlessStartRequest request) {
    return _start<PasswordlessStartResponse, Errors>()
        .withUri('/api/passwordless/start')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => PasswordlessStartResponse.fromJson(d)))
        .go();
  }
  ...
  Future<ClientResponse<TwoFactorStartResponse, Errors>> startTwoFactorLogin(TwoFactorStartRequest request) {
    return _start<TwoFactorStartResponse, Errors>()
        .withUri('/api/two-factor/start')
        .withJSONBody(request)
        .withMethod('POST')
        .withResponseHandler(defaultResponseHandlerBuilder((d) => TwoFactorStartResponse.fromJson(d)))
        .go();
  }
  ...
  /// @returns {Promise<ClientResponse<LoginResponse>>}
  Future<ClientResponse<LoginResponse, Errors>> twoFactorLogin(TwoFactorLoginRequest request) {
    return _startAnonymous<LoginResponse, Errors>()
  ...
  /// @returns {Promise<ClientResponse<IPAccessControlListResponse>>}
  Future<ClientResponse<IPAccessControlListResponse, Errors>> updateACL(String accessControlListId, IPAccessControlListRequest request) {
    return _start<IPAccessControlListResponse, Errors>()
        .withUri('/api/ip-acl')
        .withUriSegment(accessControlListId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<APIKeyResponse>>}
  Future<ClientResponse<APIKeyResponse, Errors>> updateAPIKey(String apiKeyId, APIKeyRequest request) {
    return _start<APIKeyResponse, Errors>()
        .withUri('/api/api-key')
  ...
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, Errors>> updateApplication(String applicationId, ApplicationRequest request) {
    return _start<ApplicationResponse, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<ApplicationResponse>>}
  Future<ClientResponse<ApplicationResponse, Errors>> updateApplicationRole(String applicationId, String roleId, ApplicationRequest request) {
    return _start<ApplicationResponse, Errors>()
        .withUri('/api/application')
        .withUriSegment(applicationId)
        .withUriSegment("role")
  ...
  /// @returns {Promise<ClientResponse<ConsentResponse>>}
  Future<ClientResponse<ConsentResponse, Errors>> updateConsent(String consentId, ConsentRequest request) {
    return _start<ConsentResponse, Errors>()
        .withUri('/api/consent')
        .withUriSegment(consentId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<EmailTemplateResponse>>}
  Future<ClientResponse<EmailTemplateResponse, Errors>> updateEmailTemplate(String emailTemplateId, EmailTemplateRequest request) {
    return _start<EmailTemplateResponse, Errors>()
        .withUri('/api/email/template')
        .withUriSegment(emailTemplateId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<FormResponse>>}
  Future<ClientResponse<FormResponse, Errors>> updateForm(String formId, FormRequest request) {
    return _start<FormResponse, Errors>()
        .withUri('/api/form')
        .withUriSegment(formId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<FormFieldResponse>>}
  Future<ClientResponse<FormFieldResponse, Errors>> updateFormField(String fieldId, FormFieldRequest request) {
    return _start<FormFieldResponse, Errors>()
        .withUri('/api/form/field')
        .withUriSegment(fieldId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<GroupResponse>>}
  Future<ClientResponse<GroupResponse, Errors>> updateGroup(String groupId, GroupRequest request) {
    return _start<GroupResponse, Errors>()
        .withUri('/api/group')
        .withUriSegment(groupId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<IdentityProviderResponse>>}
  Future<ClientResponse<IdentityProviderResponse, Errors>> updateIdentityProvider(String identityProviderId, IdentityProviderRequest request) {
    return _start<IdentityProviderResponse, Errors>()
        .withUri('/api/identity-provider')
        .withUriSegment(identityProviderId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<IntegrationResponse>>}
  Future<ClientResponse<IntegrationResponse, Errors>> updateIntegrations(IntegrationRequest request) {
    return _start<IntegrationResponse, Errors>()
        .withUri('/api/integration')
        .withJSONBody(request)
        .withMethod('PUT')
  ...
  /// @returns {Promise<ClientResponse<KeyResponse>>}
  Future<ClientResponse<KeyResponse, Errors>> updateKey(String keyId, KeyRequest request) {
    return _start<KeyResponse, Errors>()
        .withUri('/api/key')
        .withUriSegment(keyId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<LambdaResponse>>}
  Future<ClientResponse<LambdaResponse, Errors>> updateLambda(String lambdaId, LambdaRequest request) {
    return _start<LambdaResponse, Errors>()
        .withUri('/api/lambda')
        .withUriSegment(lambdaId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<RegistrationResponse>>}
  Future<ClientResponse<RegistrationResponse, Errors>> updateRegistration(String userId, RegistrationRequest request) {
    return _start<RegistrationResponse, Errors>()
        .withUri('/api/user/registration')
        .withUriSegment(userId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<SystemConfigurationResponse>>}
  Future<ClientResponse<SystemConfigurationResponse, Errors>> updateSystemConfiguration(SystemConfigurationRequest request) {
    return _start<SystemConfigurationResponse, Errors>()
        .withUri('/api/system-configuration')
        .withJSONBody(request)
        .withMethod('PUT')
  ...
  /// @returns {Promise<ClientResponse<TenantResponse>>}
  Future<ClientResponse<TenantResponse, Errors>> updateTenant(String tenantId, TenantRequest request) {
    return _start<TenantResponse, Errors>()
        .withUri('/api/tenant')
        .withUriSegment(tenantId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<ThemeResponse>>}
  Future<ClientResponse<ThemeResponse, Errors>> updateTheme(String themeId, ThemeRequest request) {
    return _start<ThemeResponse, Errors>()
        .withUri('/api/theme')
        .withUriSegment(themeId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<UserResponse>>}
  Future<ClientResponse<UserResponse, Errors>> updateUser(String userId, UserRequest request) {
    return _start<UserResponse, Errors>()
        .withUri('/api/user')
        .withUriSegment(userId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<UserActionResponse>>}
  Future<ClientResponse<UserActionResponse, Errors>> updateUserAction(String userActionId, UserActionRequest request) {
    return _start<UserActionResponse, Errors>()
        .withUri('/api/user-action')
        .withUriSegment(userActionId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<UserActionReasonResponse>>}
  Future<ClientResponse<UserActionReasonResponse, Errors>> updateUserActionReason(String userActionReasonId, UserActionReasonRequest request) {
    return _start<UserActionReasonResponse, Errors>()
        .withUri('/api/user-action-reason')
        .withUriSegment(userActionReasonId)
        .withJSONBody(request)
  ...
  /// @param {UserConsentRequest} request The request that contains the user consent information.
  /// @returns {Promise<ClientResponse<UserConsentResponse>>}
  Future<ClientResponse<UserConsentResponse, Errors>> updateUserConsent(String userConsentId, UserConsentRequest request) {
    return _start<UserConsentResponse, Errors>()
        .withUri('/api/user/consent')
        .withUriSegment(userConsentId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<WebhookResponse>>}
  Future<ClientResponse<WebhookResponse, Errors>> updateWebhook(String webhookId, WebhookRequest request) {
    return _start<WebhookResponse, Errors>()
        .withUri('/api/webhook')
        .withUriSegment(webhookId)
        .withJSONBody(request)
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> upsertEntityGrant(String entityId, EntityGrantRequest request) {
    return _start<void, Errors>()
        .withUri('/api/entity')
        .withUriSegment(entityId)
        .withUriSegment("grant")
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, void>> validateDevice(String user_code, String client_id) {
    return _startAnonymous<void, void>()
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> verifyEmailAddress(VerifyEmailRequest request) {
    return _startAnonymous<void, Errors>()
        .withUri('/api/user/verify-email')
        .withJSONBody(request)
        .withMethod('POST')
  ...
  Future<ClientResponse<void, Errors>> verifyRegistration(String verificationId) {
    return _startAnonymous<void, Errors>()
        .withHeader('Content-Type', 'text/plain')
        .withUri('/api/user/verify-registration')
        .withUriSegment(verificationId)
  ...
  /// @returns {Promise<ClientResponse<void>>}
  Future<ClientResponse<void, Errors>> verifyUserRegistration(VerifyRegistrationRequest request) {
    return _startAnonymous<void, Errors>()
        .withUri('/api/user/verify-registration')
        .withJSONBody(request)
        .withMethod('POST')
