...
class TimeBasedDeletePolicy extends Enableable {
  ...
  TimeBasedDeletePolicy({this.enabledInstant, this.numberOfDaysToRetain});
...
/// @author Brent Halsey
@JsonSerializable()
class WebhookSignatureConfiguration extends Enableable {
  String signingKeyId;

  WebhookSignatureConfiguration({this.signingKeyId});

  factory WebhookSignatureConfiguration.fromJson(Map<String, dynamic> json) =>
      _$WebhookSignatureConfigurationFromJson(json);
  @override
  Map<String, dynamic> toJson() => _$WebhookSignatureConfigurationToJson(this);
}
...
class ExpandableRequest {
  ...
  factory ExpandableRequest.fromJson(Map<String, dynamic> json) =>
      _$ExpandableRequestFromJson(json);
  @override
  Map<String, dynamic> toJson() => _$ExpandableRequestToJson(this);
}
...
class ExpandableResponse {
  ...
  factory ExpandableResponse.fromJson(Map<String, dynamic> json) =>
      _$ExpandableResponseFromJson(json);
  @override
  Map<String, dynamic> toJson() => _$ExpandableResponseToJson(this);
}
...
/// @author Brian Pontarelli
@JsonSerializable()
class SearchRequest extends ExpandableRequest {
...
/// @author Brian Pontarelli
@JsonSerializable()
class SearchResponse extends ExpandableResponse {
  String nextResults;
  num total;
  List<User> users;

  SearchResponse({this.nextResults, this.total, this.users});
